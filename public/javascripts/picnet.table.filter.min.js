...
function $initialiseControlCaches$$(){$headers$$=$grid$$.find("thead tr:first th");$rows$$=$grid$$.find("tbody tr");$buildFiltersRow$$();
$filters$$=$grid$$.find("thead tr:last").find("input,select");$filterColumnIndexes$$=[];$filters$$.each(function(){$filterColumnIndexes$$.push($getColumnIndexOfFilter$$($$$$1$$(this)))})}function $buildFiltersRow$$(){for(var $tr$$=$$$$1$$("<tr class='filters' ></tr>"),$i$$6$$=0;$i$$6$$<$headers$$.length;$i$$6$$++){var $header$$2$$=$$$$1$$($headers$$[$i$$6$$]),$td$$;
